...
interface ModelsListProps {
  // Keeping props for interface compatibility but making it optional
  models?: ModelType;
}
...
const ModelsList = ({ }: ModelsListProps) => {
  // Use mock data instead of models.data
  const data = mockData;
